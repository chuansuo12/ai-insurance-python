...
# self.lstm = LSTM(input_size, hidden_size, num_layers=num_layers, bias=bias,             batch_first=batch_first, dropout=dropout, bidirectional=bidirectional)
# def forward(self, input_tensor, seq_lens):
# # input_tensor shape: batch_size*time_step*dim ,
# # seq_lens: (batch_size,)  when batch_first = True
# total_length = input_tensor.size(1)
# if self.batch_first else input_tensor.size(0)
